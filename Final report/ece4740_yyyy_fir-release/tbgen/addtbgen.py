#=========================================================================
# ECE4740 Adder Group signal_gen Veriloga generator : python multbgen [options]
#=========================================================================
...
def puts_module(output_file,cp,mname):
  ...
  output_file.write(f'module {mname}(A,B,C,D);\n')
  output_file.write( '\toutput [0:15] A;\n')
  output_file.write( '\toutput [0:15] B;\n')
  output_file.write( '\toutput [0:15] C;\n')
  output_file.write( '\toutput [0:15] D;\n')
  output_file.write( '\tvoltage [0:15] A;\n')
  output_file.write( '\tvoltage [0:15] B;\n')
  output_file.write( '\tvoltage [0:15] C;\n')
  output_file.write( '\tvoltage [0:15] D;\n')
  ...
  output_file.write( '\treal Btemp[0:15];\n')
  output_file.write( '\treal Ctemp[0:15];\n')
  output_file.write( '\treal Dtemp[0:15];\n')
  output_file.write('\n')
...
def puts_caselist(output_file,caselist):
  ...
  output_file.write('\t//----------------------------------------------------------\n')
  # caselist = [[name,AAAA,BBBB,CCCC,DDDD],]
  for (i,case) in enumerate(caselist):
    ...
    output_file.write(f'\treal k{i}_B[0:15] =') 
    output_file.write(hex_decode(4,case[2]) + '\n')
    output_file.write(f'\treal k{i}_C[0:15] =') 
    output_file.write(hex_decode(4,case[3]) + '\n')
    output_file.write(f'\treal k{i}_D[0:15] =') 
    output_file.write(hex_decode(4,case[4]) + '\n')
  output_file.write('\n')
...
def puts_testsrc(output_file,caselist):
  ...
  output_file.write( '\t\t\t\tCtemp[x] = lo;\n')
  output_file.write( '\t\t\t\tDtemp[x] = lo;\n')
  ...
  for i in range(len(caselist)):
    ...
    output_file.write(f'\t\t\t\t\tCtemp[x] = k{i}_C[x];\n')
    output_file.write(f'\t\t\t\t\tDtemp[x] = k{i}_D[x];\n')
    output_file.write( '\t\t\t\tend\n')
  ...
  output_file.write( '\t\t\tV(C[i]) <+ transition(Ctemp[i], 0, tr, tf);\n')
  output_file.write( '\t\t\tV(D[i]) <+ transition(Dtemp[i], 0, tr, tf);\n')
  output_file.write( '\t\tend\n')
  output_file.write('\n')
